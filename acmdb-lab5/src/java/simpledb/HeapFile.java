...
public class HeapFile implements DbFile {
    ...
    public ArrayList<Page> insertTuple(TransactionId tid, Tuple t)
    	...
    	//return null;
        // not necessary for lab1
    	ArrayList<Page> dirtedPages = new ArrayList<>();
    ...
    public class HeapFileIterator implements DbFileIterator {
        ...
        public boolean hasNext() throws DbException, TransactionAbortedException {
            ...
            return ((HeapPage) Database.getBufferPool().getPage(tid, new HeapPageId(f.getId(), pid + 1), Permissions.READ_ONLY)).iterator().hasNext();
        ...
        public Tuple next() throws DbException, TransactionAbortedException, NoSuchElementException {
            ...
            while (!it.hasNext()) {
                ...
                pid += 1;
                it = ((HeapPage) Database.getBufferPool().getPage(tid, new HeapPageId(f.getId(), pid), Permissions.READ_ONLY)).iterator();
            }
            return it.next();
        }
        ...
        public void open() throws DbException, TransactionAbortedException {
            this.pid = 0;
            this.it = ((HeapPage) Database.getBufferPool().getPage(tid, new HeapPageId(f.getId(), this.pid), Permissions.READ_ONLY)).iterator();
